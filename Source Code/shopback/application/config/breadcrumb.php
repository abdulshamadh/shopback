...
$config['replacer'] = array();
$config['replacer'] = array('getOrderDetails' =>'Order Details','order' =>'Order List','member' =>'courses','profileUpdate'=>'edit profile','category'=>'All categories','updateAddresses'=>'Manage Address','addresses'=>'Manage Address','search'=>'Search Results','searchresults'=>'Search Results','advancedsearch'=>'Advanced Search','updateuserpassword'=>'Change Password','updateProfile'=>'Manage Profile');
 ...
 */
$config['exclude']= array('s','page','product','home','remove','profile','index','content');
/**
 * ------------------------------------
